...
namespace FactOfHuman.Migrations
{
    ...
    partial class FactOfHumanDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FactOfHuman.Models.PostBlockImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FactOfHuman.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("ActiveTokenExpireAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("FactOfHuman.Models.PostBlockImage", b =>
                {
                    b.HasOne("FactOfHuman.Models.PostBlock", null)
                        .WithMany("BottomImage")
                        .HasForeignKey("PostBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FactOfHuman.Models.PostBlock", "postBlock")
                        .WithMany("TopImage")
                        .HasForeignKey("postBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
